...
def convert_quantity(quantity,convert_from,convert_to):
    if convert_from == convert_to:
        return quantity
    elif (convert_from == 'kilogram' and convert_to == 'gram') or (convert_from == 'litre' and convert_to == 'millilitre'):
        return quantity * 1000
    elif (convert_from == 'gram' and convert_to == 'kilogram') or (convert_from == 'millilitre' and convert_to == 'litre'):
        return quantity / 1000
